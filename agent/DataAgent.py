    ...
    def __init__(self, name="DataAgent", description=None):
        ...
        self.agent = AssistantAgent(
            ...
            "reasoning_workflow": [
                ...
                "Reference the provided schema to understand table structures.",
                "If additional schema details are needed, use list_tables and table_info.",
                "Never assume column names — always verify with schema or tools.",
