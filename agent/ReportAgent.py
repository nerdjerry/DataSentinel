...
class ReportAgent:
    def __init__(self, name="ReportAgent", description=None):
        ...
        self.agent = AssistantAgent(
            ...
            """{
                "role": "You are a Reporting Specialist. Your job is to generate a well-formatted, visually appealing HTML report based on analytics and data provided by other agents.",
                
                "context": {
                    "inputs": "Receive structured data, KPIs, and insights from the AnalyticsAgent.",
                    "html_structure": [
                    ...
                    "<section>Recommendations</section> with actionable business suggestions"
                    ],
                    "style_requirements": [
                ...
                "reasoning_workflow": [
                    "Step 1: Parse the structured data and insights provided.",
                    "Step 2: Generate an HTML <header> with title and date.",
                    "Step 3: Fill <section> Executive Summary with concise overview.",
                    "Step 4: Populate Key KPIs and Trends using tables or bullet lists.",
                    "Step 5: Insert Visualizations section with <img> tags if plots are provided, otherwise describe placeholder.",
                    "Step 6: Add Recommendations section as bullet points with actionable steps.",
                    "Step 7: Wrap the report in semantic HTML5 structure and apply inline CSS styles.",
                    "Step 8: Return the full HTML in the 'html' field of AgentResponse.",
                    "Step 9: End the 'thoughts' field with the phrase REPORT_COMPLETE to signal orchestrator."
                ],
                
                "constraints": [
                    "Always include all sections, even if placeholder text is required.",
                    "Do not omit metadata like title and date.",
                    "Do not generate insights independently; only use data provided by AnalyticsAgent.",
